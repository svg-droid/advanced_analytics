...
<div class="row" id="<?php echo $_GET['pid']; ?>">
    <div class="col-lg-12">
        <div class="widget-container fluid-height clearfix">
            <div class="heading">
                <i style="cursor:default;" class="icon-table"></i> Wish List
                <?php
            ...
            <!--    <div class="btn-group hidden-xs pull-right ajesh_margin_right_10">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="javascript:void(0)" onclick="statusactive('Active','active','wishlist')"><i class="icon-ok-sign"></i>Active</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" onclick="statusinactive('Inactive','inactive','wishlist')"><i class="icon-ok-circle"></i>Inactive</a>
                        </li>
                          <?php if($moduleresult['p_field4'] == 1){ ?>
					  <li>
						<a href="javascript:void(0)" onclick="deleteselected('Delete','delete','wishlist')"><i class="icon-remove"></i>Delete</a>
					  </li>
                      <?php } ?>
                    </ul>
                </div>-->
                ...
                <table class="table table-bordered table-striped" id="tbl_data_display">
                    <thead>
                        ...
                        <th class="hidden-xs" style="color: #007aff;">User Name</th>
                         ...
                         <th class="hidden-xs" style="color: #007aff;">Collection</th>
			...
			var fk_userid = '<?php echo decode($_REQUEST['id']); ?>'
                        $('#tbl_data_display').dataTable({
                            ...
                            "sAjaxSource": site_url + 'controllers/ajax_controller/wishlist-ajax-controller.php?action=displaydata&fk_userid='+ fk_userid
                        });
                    });
                </script>
            </div>
