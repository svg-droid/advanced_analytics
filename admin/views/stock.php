...
<script type="text/javascript" src="<?php echo $LOCATION['SITE_ADMIN'];?>views/javascripts/stock.js?<?php echo time(); ?>"></script>
...
<div class="row" id="<?php echo $_GET['pid']; ?>">
    <div class="col-lg-12">
        <div class="widget-container fluid-height clearfix">
            <div class="heading">
                <i style="cursor:default;" class="icon-table"></i> Stock List
               ...
               <!-- <div class="btn-group hidden-xs pull-right ajesh_margin_right_10">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="javascript:void(0)" onclick="statusactive('Active','active','stock')"><i class="icon-ok-sign"></i>Active</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" onclick="statusinactive('Inactive','inactive','stock')"><i class="icon-ok-circle"></i>Inactive</a>
                        </li>
                          <?php if($moduleresult['p_field4'] == 1){ ?>
					  <li>
						<a href="javascript:void(0)" onclick="deleteselected('Delete','delete','stock')"><i class="icon-remove"></i>Delete</a>
					  </li>
                       <?php } ?>
                    </ul>
                </div>-->
            ...
            <div class="widget-content padded clearfix">
                <table class="table table-bordered table-striped" id="tbl_data_display">
                    <thead>
					   ...
					   <th class="hidden-xs" style="color: #007aff;">Brand</th>
					   <th class="hidden-xs" style="color: #007aff;">Collection</th>
                        <th class="hidden-xs" style="color: #007aff;">Product Name</th>
                         <th class="hidden-xs" style="color: #007aff;">Power</th>
                          <th class="hidden-xs" style="color: #007aff;">Available QTY</th>
                           <th class="hidden-xs" style="color: #007aff;">Sold QTY</th>
                         <!--   <th class="hidden-xs" style="color: #007aff;">Available Right Power</th>
                             <th class="hidden-xs" style="color: #007aff;">Sold Right Power</th>
                            -->
                ...
                <script>
                    $(document).ready(function() {
                        $('#tbl_data_display').dataTable({
                            ...
                            "sAjaxSource": site_url + 'controllers/ajax_controller/stock-ajax-controller.php?action=displaydata'
                        });
                    });
                </script>
            </div>
