...
<div class="row" id="<?php echo $_GET['pid']; ?>">
    <div class="col-lg-12">
        <div class="widget-container fluid-height clearfix">
            <div class="heading">
                <i style="cursor:default;" class="icon-table"></i> Shipping Charge List
            ...
            <div class="widget-content padded clearfix">
                <table class="table table-bordered table-striped" id="tbl_data_display">
                    <thead>
                        ...
                        <th class="hidden-xs" style="color: #007aff;">Kuwait</th>
                        <th class="hidden-xs" style="color: #007aff;">Qatar</th>
						<th class="hidden-xs" style="color: #007aff;">Saudi Arebia</th>
                        <th class="hidden-xs" style="color: #007aff;">Bahrain</th>
                        <th class="hidden-xs" style="color: #007aff;">UAE</th>
