function adddata(){
	var flag = 0;
		...
		if(requiredValidate('prdname',marketingLinkMsg)){
			flag++;
		}     
	if(requiredValidate('text_astock',marketingLinkMsg)){
			flag++;
		}   
		 if(requiredValidate('text_tstock',marketingLinkMsg)){
			flag++;
		}   	        
		if(flag>0){
			return false;
			...
			var options = {
				...
				url:       site_url+'controllers/ajax_controller/stock-ajax-controller.php', 
				type: "POST"
			};
