function adddata(){
	var flag = 0;
		...
		if(requiredValidate('orderno',OrdernoMsg)){
			flag++;
		}

		if(requiredValidate('addcustomer',CustomerMsg)){
			flag++;
		}  
		if(requiredValidate('addproduct',ProductSelMsg)){
			flag++;
		}
		if(requiredValidate('productqty',QuantityMsg)){
			flag++;
		}
