function adddata(){
	...
	if(requiredValidate('countryname',countryMsg)){
            flag++;
        }
    if(requiredValidate('short_name',CountryShortNameMsg)){
            flag++;
        }
    if(requiredValidate('c_name',CountryCurrencyMsg)){
            flag++;
        }
    if(requiredValidate('symbol',CountrySymbolMsg)){
            flag++;
        }	    
	if(img!='' && regexValidate('txt_addlogo',CountryImg,photoValidMsg,'img')){
		   flag++;
		 }
