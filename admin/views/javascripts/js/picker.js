...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('http://192.168.1.98:1000/familybuzz/admin/picker.html', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
