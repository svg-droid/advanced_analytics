function adddata(){
	...
	if(requiredValidate('bannername',bannerMsg)){
			flag++;
		} 
	...
	if(regexValidate('image',BannerImg,photoValidMsg,'img')){
		   flag++;
		 }	    
...
function updatedata(){
	...
	if(requiredValidate('banner_name',bannerMsg)){
			flag++;
		} 
	if(requiredValidate('brand_type',brandtypemsg)){
			flag++;
		} 
   if(img!='' && regexValidate('image',BannerImg,photoValidMsg,'img')){
		   flag++;
		 }
		if(flag>0){
			return false;
