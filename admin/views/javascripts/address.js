function adddata(){
	...
	//  if(requiredValidate('AddProductid',AddCategoryMsg)){
 //           flag++;
 //         }
	// if(requiredValidate('attributename',attributenameMsg)){
	// 		flag++;
	// 	} 
 //   if(requiredValidate('attributevalues',attributevaluesMsg)){
	// 		flag++;
	// 	} 

	// if(regexValidate('image',CatImg,photoValidMsg,'img')){
	//    flag++;
	//  }       
	  ...
	  if(flag>0){
			...
			var options = {
				...
				url:       site_url+'controllers/ajax_controller/address-ajax-controller.php', 
				type: "POST"
			};
