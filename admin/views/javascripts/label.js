function adddata(){
	...
	if(requiredValidate('labelname',labelnameMsg)){
			flag++;
		} 
   if(requiredValidate('labelvalues',labelvaluesMsg)){
			flag++;
		}      
	  ...
	  if(flag>0){
			...
			var options = {
				...
				url:       site_url+'controllers/ajax_controller/label-ajax-controller.php', 
				type: "POST"
			};
