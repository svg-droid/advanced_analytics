function adddata(){
	var flag = 0;
	if(requiredValidate('evmtitle',evmtitleMsg)){
            flag++;
}
if(requiredValidate('txt_addphoto',txt_addphotoMsg)){
					flag++;
}
	if(flag>0){
			return false;
			...
			var options = {
				...
				url:       site_url+'controllers/ajax_controller/userassessment-ajax-controller.php',
				type: "POST"
			};
