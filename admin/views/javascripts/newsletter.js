function adddata(){
    ...
    var email=$("#email").val();       
        ...
        if(requiredValidate('AddPosttype',AddPosttypeMsg)){
            flag++;
        } 

       if(regexValidate('email',postemailMsg,emailValidMsg,'email')){
           flag++;
         }  
         if(requiredValidate('name',postnameMsg)){
            flag++;
        }    
        if(flag>0){
            return false;
...
function updatedata(){
    ...
    var email=$("#email").val();       
        ...
        if(requiredValidate('AddPosttype',AddPosttypeMsg)){
         ...
         if(email!='' && regexValidate('email',postemailMsg,emailValidMsg,'email')){
           flag++;
         }    
         if(requiredValidate('name',postnameMsg)){
            flag++;
