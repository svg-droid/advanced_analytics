function adddata(){
    var flag = 0;
    if(requiredValidate('AddCategory',AddCategoryMsg)){
            flag++;
        } 
    if(requiredValidate('subcategory_name',subcategoryMsg)){
            flag++;
        }        
        if(flag>0){
            return false;
            ...
            var options = {
                ...
                url:       site_url+'controllers/ajax_controller/subcategory-ajax-controller.php', 
                type: "POST"
            };
